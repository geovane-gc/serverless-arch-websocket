...
const apiKeysToAccountIds: any = {
  "0x037f902f893b5d6184fd512678a9a843c4f9033e945819232712c3ce767de9e268": "itau",
...
export const handler = async (event: any) => {
  ...
  if (apiKey in apiKeysToAccountIds) {
    const generateAllowVar = generateAllow(apiKey, event.methodArn, apiKeysToAccountIds[apiKey]);
...
*/
async function generatePolicy(principalId: string, effect: string, resource: string, accountId: string = '') {
...
async function generateAllow(principalId: string, resource: string, accountId: string) {
